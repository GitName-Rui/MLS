<template>
  <div id="M-PC-top-nav">
        <ul class="list-inline">
            ...
            <li v-show="isLogin" class="my-center" @mouseenter="center(true)" @mouseleave="center(false)">
                <a href="javascript:;">{{uname}}<em class="arrow"></em></a>
                <ul class="my-center-detail">
                    <li><a href="javascript:;">账号与安全</a></li>
                    <li><a href="javascript:;" @click="logout">退出</a></li>
                </ul>
            </li>
            <li class="my-collect" @mouseenter="collect(true)" @mouseleave="collect(false)">
                <a href="javascript:;" class="collect-menu"><em class="collect"></em>我的收藏</a>
                <ul class="collect-des">
            ...
            <li class="help-center" @mouseenter="help(true)" @mouseleave="help(false)">
...
export default {
    ...
    methods:{
        ...
        center(bool){
            if(bool){
                $('ul.my-center-detail').css({display:"block"});
            }else{
                $('ul.my-center-detail').css({display:"none"});
            }
        },
        collect(bool){
            if(bool){                    
                $("ul.collect-des").css({display:"block"});
            }else{
                $("ul.collect-des").css({display:"none"});
            }         
        },
        help(bool){
            if(bool){
                $("ul.help-des").css({display:"block"});
            }else{
                $("ul.help-des").css({display:"none"});
            }          
        }
    }
}
